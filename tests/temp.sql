...
-- A) existe rota elegível? (75 = LCI, 843 = LCA)
SELECT COUNT(*) FROM CETIP.TIPO_OPER_OBJETO_SERV tos
...
-- B) existe LCI em lote tipo 1? (e LCA em tipo 2)
SELECT L.NUM_ID_TIPO_LOTE, COUNT(DISTINCT I.NUM_IF)
FROM CETIP.INSTRUMENTO_FINANCEIRO I JOIN CETIP.LOTE L ON L.NUM_ID_LOTE = I.NUM_ID_LOTE
WHERE I.NUM_TIPO_IF = 81 AND I.DAT_EXCLUSAO IS NULL
GROUP BY L.NUM_ID_TIPO_LOTE ORDER BY 2 DESC;
