...
INNER JOIN {{RAW_TIPO_OPER_OBJETO_SERV}} TOOS
    ON TOOS.NUM_ID_TIPO_OPER_OBJETO_SERV =
       O.NUM_ID_TIPO_OPER_OBJETO_SERV
INNER JOIN {{RAW_TIPO_OPERACAO}} TOP
    ON TOP.NUM_ID_TIPO_OPERACAO =
       TOOS.NUM_ID_TIPO_OPERACAO
INNER JOIN {{RAW_CONTA_PARTICIPANTE}} CP
    ON CP.NUM_CONTA_PARTICIPANTE =
       O.NUM_CONTA_PARTICIPANTE_P1
WHERE TOP.COD_TIPO_OPERACAO = 1
  AND CP.NUM_ID_SITUACAO_CONTA IN (1, 2);
